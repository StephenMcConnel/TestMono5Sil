...
namespace TestMono5Sil
{
	...
	{
		protected WizardControl _winformsWizard;
		...
		public void Setup()
		{
			InitializeControl = () =>
			{
				_winformsWizard = new WizardControl();
	...
	class WizardAdapterPage : Control
	{
		...
		internal WizardPage WinFormPage
		{
			get
			{
				return _winformPage;
